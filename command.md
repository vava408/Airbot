...
| Commande | Type | Description | Statut |
|----------|------|-------------|--------|
...
| `mute` | 🔒 Modération | Empêche un utilisateur de parler/écrire. | ✅ |
| `unmute` | 🔒 Modération | Retire le mute d’un utilisateur. | ✅ |
| `warn` | 🔒 Modération | Donne un avertissement à un utilisateur. | ✅ |
| `clear` | 🔒 Modération | Supprime un nombre défini de messages. | ✅ |
| `slowmode` | 🔒 Modération | Définit un délai obligatoire entre les messages d’un salon. | ✅ |
| `tempmute` | 🔒 Modération | Mute temporairement un utilisateur pour une durée définie. | 🛠️ |
| `softban` | 🔒 Modération | Ban puis unban un utilisateur pour nettoyer ses messages. | 🛠️ |
| `lock` | 🔒 Modération | Verrouille un salon (empêche les messages). | 🛠️ |
| `unlock` | 🔒 Modération | Déverrouille un salon. | 🛠️ |

---

## 🟧 Priorité Moyenne (infos & gestion avancée)
| Commande | Type | Description | Statut |
|----------|------|-------------|--------|
| `avatar` | 👤 Info | Affiche l’avatar d’un utilisateur. | ✅ |
...
| `levelupchan` | 🎯 Niveau | Définit le salon où envoyer les messages de level-up. | ✅ |
| `setxp` | 🎯 Niveau | Permet d’ajouter ou modifier l’XP d’un utilisateur. | ✅ |
| `servericon` | 🌐 Info | Montre l’icône du serveur. | 🛠️ |
...
## 🟩 Priorité Basse (fun & engagement)
| Commande | Type | Description | Statut |
|----------|------|-------------|--------|
| `rank` | 🎯 Niveau | Affiche ton niveau et ton XP actuels. | ✅ |
