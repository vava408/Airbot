...
| `tempmute` | 🔒 Modération | Mute temporairement un utilisateur pour une durée définie. | ✅ |
| `softban` | 🔒 Modération | Ban puis unban un utilisateur pour nettoyer ses messages. | ✅ |
| `lock` | 🔒 Modération | Verrouille un salon (empêche les messages). | ✅ |
| `unlock` | 🔒 Modération | Déverrouille un salon. | ✅ |
